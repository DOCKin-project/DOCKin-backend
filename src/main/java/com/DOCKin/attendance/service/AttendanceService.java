...
public class AttendanceService {
    ...
    private AttendanceDto clockInTx(String userId, ClockInRequestDto dto) {
        try {
            return transactionTemplate.execute(status -> doClockIn(userId, dto));

...
public enum ErrorCode {
   ...
   // Chat
    ...
    ATTENDANCE_CLOCK_IN_STALE(409, "AT006", "출근 후 16시간이 지난 기록은 퇴근 처리할 수 없습니다. 관리자에게 문의하세요."),
    ...
    ABSENCE_NOT_CANCELLABLE(409, "AB008", "대기 중이거나 승인된 신청만 취소할 수 있습니다."),
    ABSENCE_ALREADY_STARTED(409, "AB009", "이미 시작된 휴가는 취소할 수 없습니다. 관리자에게 문의하세요."),

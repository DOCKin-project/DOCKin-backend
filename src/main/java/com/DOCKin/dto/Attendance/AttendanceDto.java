...
public class AttendanceDto {
    ...
    @Schema(description = "그냥 조회용")
    private Long id;

    @Schema(description = "사원번호", example = "1001")
    private String userId;

    //출근,퇴근 시간
    @Schema(description = "출근한 시간", example = "2026-01-01 09:00:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime clockInTime;

    @Schema(description = "퇴근한 시간", example = "2026-01-01 09:00:00")
    ...
    //출퇴근장소
    @Schema(description = "출근 장소", example = "제1조선소")
